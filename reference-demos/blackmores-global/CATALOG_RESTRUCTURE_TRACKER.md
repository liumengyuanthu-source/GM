# General Mills Catalog Restructure Tracker
...
This document tracks the planned restructuring of the General Mills catalog into six business-oriented groups. It is based on:

- `MARKET_POSITIONING.md`
- `index.html` current catalog
- `Docs/Strategy/AI Application Scenario Map - Retail Industry.pdf`

The goal is to make the catalog feel like a retail industry scenario library, while preserving the General Mills-specific story: channel enablement first, data/content/compliance capture second, and long-term DTC consumer relationship building third.
...
| Group | Role in General Mills Story |
|---|---|
...
| Retail & Channel Operations | Retail, retail chain, distributor, field sales, shelf execution, sell-through and replenishment |
| Membership & Occasion Engagement | Loyalty, occasion companion experiences, repurchase, member benefits and long-term consumer relationship |
...
|---|---|---|
| Knowledge Graph | Expanded from a thin product graph into a General Mills AI Knowledge Hub demo: product truth graph, claim governance, marketplace/channel use cases, and a reference architecture walkthrough adapted from the Honda Knowledge Graph reference. | Updated |
| AI Transformation Navigator | Rebuilt using the full Honda navigator information architecture, adapted for General Mills: new AI reality, four transformation shifts, AI-readable foundation, full responsible-AI governance playbook, framework tables, requirements alignment, outcomes, NTT DATA value proposition, AI journey support and three-horizon roadmap. | Updated |
| Retail AI Scenario Portfolio | Added a portfolio entry page with the original Retail Industry scenario-map PDF embedded in a browser PDF viewer, plus General Mills six-domain mapping and execution backlog. | Updated |
...
| Consumer Insight & VOC | Repositioned the VOC page as a Consumer Growth insight engine: all-channel General Mills listening, AI insight summary, competitive edge, next best action, growth opportunities, voice root-cause drilldown and insight-to-action tasks. The Consumer Growth catalog card now opens this demo. | Updated |
| Social Hub | Expanded the General Mills social operations demo with richer multi-market sample data: account matrix, social inbox, compliant AI replies, social listening topics, negative-theme routing, campaign recommendations and one-click campaign kits. | Updated |
...
|---|---|---|---|
| Marketplace Operations Cockpit | Platform Commerce | Makes General Mills platform commerce operations explicit across marketplaces and digital channels, including sell-out, inventory risk, PDP content health, and claim consistency | Detailed page created and linked; absorbs Platform Sell-out & Inventory Dashboard and Cross-Platform Häagen-Dazs Mini Cupontent Governance |
...
| Distributor Sell-through Intelligence | Retail & Channel Operations | Connects distributor, retail and retail sell-through data to replenishment and field actions | Concept card added |
| Repurchase Trigger Engine | Membership & Occasion Engagement | Converts occasion journey and product-cycle data into repeat purchase and member actions | Concept card added |
| Claim Compliance Governance | Trust, Compliance & Data Foundation | Makes compliant product claims and localized content approval a clear AI scenario | Concept card added |
...
## Lower-Priority Or Not Suitable For General Mills

These scenario-map items are retail-relevant but should not be prioritized for General Mills unless the story changes.
...
| Unmanned Retail Store | Not central to General Mills' channel model |
| Robot Last-mile Delivery | Logistics-heavy and not a core General Mills differentiator |
| In-store Fault Diagnosis | More relevant to electronics, appliances or automotive |
| Workday Snack Consumption / Intelligent Scheduling | Useful retail ops topic, but low relevance to current General Mills positioning |
...
- Prefer General Mills-specific scenarios that strengthen the channel-to-consumer relationship story.
